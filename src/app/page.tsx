  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7] font-sans pb-24">
      ...
      <main className="px-4 mt-4">
        {/* Banners */}
        <div className="bg-gradient-to-r from-[#DC0034] to-[#E7C154] rounded-xl p-4 mb-5 text-white shadow-sm relative overflow-hidden flex items-center justify-between min-h-[90px]">
          {/* Logo on the left */}
          <div className="relative z-10 h-[55px] w-[45%] flex-shrink-0 flex items-center justify-start">
            <img src="/logo.png" alt="Logo" className="max-h-full max-w-full object-contain object-left" />
          </div>

          {/* Text on the right */}
          <div className="relative z-20 text-right flex-1 pl-2">
            <h2 className="text-[16px] sm:text-lg font-bold mb-1.5 tracking-wider leading-tight">房抵易融·贷款服务平台</h2>
            <p className="text-[11px] sm:text-xs opacity-90">房抵·车抵·企业贷·公积金贷 全覆盖</p>
          </div>
        </div>
